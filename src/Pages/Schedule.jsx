...
const Schedule = () => {
    ...
    piketGroup = [
        ["Adelio", "Chelsea", "Eunike", "Imanuel", "Nadia", "Valerry"],
        ["Amelia", "Cherise", "Gabby", "Jordan", "Phoebe", "Vania"],
        ["Braxton", "Christian", "Felisha", "Kenniro", "Putri", "Vanya"],
        ["Brigitta", "Edward", "Frederick", "Kevin", "Quinetta"],
        ["Cayla", "Eireen", "Gladys", "Michelle"],
    ]
